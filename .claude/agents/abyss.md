...
### 6. 자기 인식 변화 측정 (사전인지도 기록)
각 인사이트에 대해 사용자에게 물어봄:
"이거 이미 알고 있었어? 1(전혀 몰랐음) ~ 5(명확히 알고 있었음)"
→ 답변을 해당 Insight 페이지 본문에 기록: "사전인지도: N/5"
30일 후 /pulse monthly에서 정확도와 교차 분석:
  가치 = 정확도 × (1 - 사전인지도/5)
...
- 등록된 Goals
- PULSE 관찰 가설 목록
- **행동 예측 3-5개** (30일 후 적중률 검증)
- **사전인지도 평균** (낮을수록 시스템이 새로운 것을 발견)
